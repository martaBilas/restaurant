...
export const OrderStatusAnalyticsCard = (({ datasource }) => (
  <CardAnalytics title='Order Stauses by Range' contentClass='sales-by-category'>
    <PieChart id='pie' className='sales-pie' dataSource={datasource} type='doughnut' diameter={1} innerRadius={0.7}>
