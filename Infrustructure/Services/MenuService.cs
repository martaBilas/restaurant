...
public class MenuService : IMenuService
{
	...
	public async Task AddMealToMenu(string name, int categoryId, double price, double? weight, IFormFile image, string description, bool isActive)
	{
	...
	public async Task UpdateMeal(long id, string name, int categoryId, double price, double weight, IFormFile image, string? description, bool isActive)
	{
		var meal = _db.Meals.FirstOrDefault(c => c.Id == id);
